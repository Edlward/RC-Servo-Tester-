...
uint32_t micros(void)
{
    ...
    return (ms * 1000) + (48000 - cycle_cnt) / 48;		//72º¯°æ
}
...
void systemInit(void)
{
    ...
    uint32_t i;
     gpio_config_t gpio_cfg[] = {
         ...
         { LED2_GPIO, LED2_PIN, GPIO_Mode_OUT ,GPIO_Speed_2MHz, GPIO_PuPd_NOPULL}, 
         { LED3_GPIO, LED3_PIN, GPIO_Mode_OUT ,GPIO_Speed_2MHz, GPIO_PuPd_NOPULL}, 

         { PUSH_SW_GPIO, PUSH_SW_PIN, GPIO_Mode_IN ,GPIO_Speed_2MHz, GPIO_PuPd_UP}, 
         { MODE_SW_GPIO, MODE_SW_PIN, GPIO_Mode_IN ,GPIO_Speed_2MHz, GPIO_PuPd_UP}, 
		 //        { SW_GPIO, SW_PIN, GPIO_Mode_OUT, GPIO_Speed_2MHz, GPIO_PuPd_UP }, 
      //   { IR_LED_GPIO, IR_LED_PIN, GPIO_Mode_OUT, GPIO_Speed_50MHz, GPIO_PuPd_NOPULL }, 
//       { J1_GPIO, J1_PIN, GPIO_Mode_IN, GPIO_Speed_2MHz, GPIO_PuPd_DOWN}, 
//         { J2_GPIO, J2_PIN, GPIO_Mode_IN, GPIO_Speed_2MHz, GPIO_PuPd_DOWN}, 
//         { J3_GPIO, J3_PIN, GPIO_Mode_IN, GPIO_Speed_2MHz, GPIO_PuPd_DOWN}, 
//        { J4_GPIO, J4_PIN, GPIO_Mode_IN, GPIO_Speed_2MHz, GPIO_PuPd_DOWN}, 
